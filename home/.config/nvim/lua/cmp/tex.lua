...
function source:complete(_, callback)
	callback {
		...
		preamble { label = ":comment",            insertText = snippet:get "tex/preamble-comment.tex" },
		...
		snippet.snippet { label = ":table",       insertText = snippet:get "tex/env-tabular.snippet.tex" },
		...
		snippet.snippet { label = ":begin",       insertText = environment { append = "$2" } },
		...
		snippet.snippet { label = ":definition",  insertText = environment { env = "definition", append = "[$1]\\label{def-$2}" } },
		...
		-- BEAMER:
		snippet.snippet { label = ":beamergotobutton",  insertText = "\\hyperlink{$0}{\\beamergotobutton{${1:Goto}}}" },
		snippet.snippet { label = ":beamerreturnbutton",  insertText = "\\hyperlink{$0}{\\beamerreturnbutton{${1:Return}}}" },
